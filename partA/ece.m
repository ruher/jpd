...
l3v10=composite([4,8,12,16,20,24,28,32,36,40,44,49],5:end);
L3=composite;

%------L4
load L4.mat
l4v4=composite([1,7,13,19,25,30,34,39,44,49,54,59,64,68,72,76,80,84,89,96],5:end);
l4v6=composite([2,8,14,20,26,31,40,45,50,55,60,65,69,73,77,81,85,90,end],5:end);
l4v8=composite([3,9,15,21,27,32,36,41,46,51,56,61,66,70,74,78,82,86,93],5:end);
l4v10=composite([10,16,22,28,33,37,42,47,52,57,62],5:end);
l4v12=composite([5,11,17,23,29],5:end);
L4=composite;
...
% ------L9
load L9.mat
l9v6=composite([1,4,7,10,13,16,19,22,25,28,31,34,37,40,44,47,50,53,56,59],5:end);
l9v8=composite([2,5,8,11,14,17,20,23,26,29,32,35,38,41,45,48,51,54,57,60],5:end);
l9v10=composite([3,6,9,12,15,18,21,24,27,30,33,36,39,42,46,49,52,55,58,end],5:end);
L9=composite;

% ------
selected=l5v8;
FF=0:1:size(selected,1);%电场
